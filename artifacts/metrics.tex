...
To accommodate long-tailed distributions and rank-sensitive behavior, we utilize soft and structural metrics instead of strict top-$k$ accuracy. The evaluation spans six complementary dimensions—ranking performance, temporal responsiveness, root-cause localization, propagation path identification, community-aware effectiveness, and computational efficiency—providing a comprehensive assessment of both predictive accuracy and structural interpretability.
